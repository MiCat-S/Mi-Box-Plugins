...
import {activity,MAX_MESSAGES,prune,restore,trimGroups,upsert,type Cached,type Chat} from "./v2/cache";
...
export default function createFbi(){let context:PluginContext|undefined,chats=new Map<string,Chat>(),watches=new Map<string,Watch>(),rebuilding=false,cacheLimit=300,activityClock=0;
