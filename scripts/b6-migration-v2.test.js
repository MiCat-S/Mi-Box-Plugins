...
const keys = {"jupai": ["jupai"], "keep_online": ["keep_online"], "keyword": ["keyword"], "kkp": ["kkp"], "komari": ["komari"], "leech": ["leech"], "listusernames": ["listusernames"], "lottery": ["lottery"], "lu_bs": ["lu_bs"], "manage_admin": ["manage_admin"], "mode": ["mode"], "moyu": ["moyu"], "music_bot": ["music_bot", "mbs", "mbkw", "mbkg", "mbqq", "mbne", "mbvk", "mbym"], "netease": ["netease"], "news": ["news"], "nezha": ["nezha"], "nodeseek": ["nodeseek"], "ntp": ["ntp"], "openlist": ["openlist", "op"], "oxost": ["0x0"]};
const paths = {"keyword": ["list", "list all", "rm", "alias", "alias rm"], "komari": ["_set_url", "status", "total", "show"], "leech": ["db", "stats", "session"], "lottery": ["create", "create list", "prize", "prize create", "prize add", "prize list", "prize clear", "draw", "status", "list", "delete", "cancel", "winners", "claim", "expire"], "lu_bs": ["sub", "unsub", "reload", "list", "订阅", "退订", "列表", "重载"], "manage_admin": ["add", "set", "rm", "remove", "del", "list", "ls"], "mode": ["global", "whitelist", "blacklist", "off", "global off", "del", "global del", "bold", "global bold", "italic", "global italic", "underline", "global underline", "mask", "global mask", "all", "global all", "whitelist add", "whitelist remove", "whitelist rm", "whitelist list", "blacklist add", "blacklist remove", "blacklist rm", "blacklist list"], "music_bot": ["search", "kugou", "kuwo", "qq", "netease", "vk", "ym"], "nezha": ["set", "service", "service on", "service off", "chart"], "nodeseek": ["set", "status", "now", "auto", "auto on", "auto off"], "ntp": ["s"], "openlist": ["status", "install", "update", "uninstall", "login", "setdefault", "save", "admin", "admin setuser", "admin setpass", "admin random", "setport", "backup", "restore"]};
function load(id) {
...
test('B6 help preserves operational instructions and accurate examples', () => {
  const anchors = {
    ...
    ntp: ['HTTPS Date', 'time.cloudflare.com', '/bin/date', 'Linux/macOS'],
